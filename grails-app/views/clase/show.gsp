...
<html>
    ...
    <body>
        ...
        <div id="show-clase" class="content scaffold-show" role="main">
            ...
            <f:display bean="clase" />
            <g:form resource="${this.clase}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.clase}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
