...
<html>
    ...
    <body>
        ...
        <div id="show-especie" class="content scaffold-show" role="main">
            ...
            <f:display bean="especie" />
            <g:form resource="${this.especie}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.especie}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
