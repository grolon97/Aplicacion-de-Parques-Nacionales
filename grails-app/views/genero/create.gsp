...
<html>
    ...
    <body>
        <a href="#create-genero" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-genero" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.genero}" method="POST">
                <fieldset class="form">
                    <f:all bean="genero"/>
                </fieldset>
