    ...
    <body>
       <div class="col-md-10 col-xs-10" style="padding-top:15px;padding-left:50px;margin:0">  
            <div class="nav" role="navigation">
                    <g:link class="fa fa-plus solo" action="create"><button class="btn">Agregar Objetivo</button></g:link>
            </div>
            <div id="list-objetivo" class="content scaffold-list" role="main">
                ...
                <f:table collection="${objetivoList}" />
    
                <div class="pagination">
                    <g:paginate total="${objetivoCount ?: 0}" />
                </div>
            </div>  
       </div>
    </body>
