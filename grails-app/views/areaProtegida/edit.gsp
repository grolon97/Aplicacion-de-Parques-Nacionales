...
<html>
    ...
    <body>
        <a href="#edit-areaProtegida" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-areaProtegida" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.areaProtegida}" method="PUT">
                <g:hiddenField name="version" value="${this.areaProtegida?.version}" />
                <fieldset class="form">
                    <f:all bean="areaProtegida"/>
                </fieldset>
