...
class ImagenControllerSpec extends Specification implements ControllerUnitTest<ImagenController>, DomainUnitTest<Imagen> {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.imagenService = Mock(ImagenService) {
            1 * save(_ as Imagen) >> { Imagen imagen ->
    ...
    void "Test the show action with a valid id"() {
        ...
        model.imagen instanceof Imagen
    }
